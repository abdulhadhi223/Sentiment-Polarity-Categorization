            ...
            <div class="container d-flex align-items-center">
                ...
                <nav id="navbar" class="navbar">
                    <ul>
                        ...
                        <li><a class="active" href="View_product.jsp">View Product</a></li>
            ...
            <section id="about" class="about">
                <div class="container">
                    <div class="row content">
                        <center><h2>All Products</h2><br><br></center>
                        <table id="customers" style="margin-right: 300px">
                            ...
                            %>
                            <tr>
                                <td><img src="Getimage?id=<%=rs.getString("id")%>" width="220" height="200"></td>
