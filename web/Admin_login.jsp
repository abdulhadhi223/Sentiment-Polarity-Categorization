            ...
            <section id="about" class="about">
                <div class="container">
                    <div class="row content">
                        <center><h2>Admin Login</h2><br><br></center>
                        <div class="col-lg-6">
                            <img src="images/admin.jpg" width="400" height="350">
                        </div>
                        <div class="col-lg-6">
                            <form action="admin" method="post" role="form">
                                <div class="col-md-6">
                                    <label>Email :</label>
                                    <input type="text" class="form-control-lg" name="name" id="subject" placeholder="Enter Your Email ID" required="required"><br><br>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <button type="submit" class="btn-primary btn-lg">Login</button>
                                </div>
                            </form>
                        </div>
                    </div>
