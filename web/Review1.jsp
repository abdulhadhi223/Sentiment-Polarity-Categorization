                    ...
                    <div class="row content">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control-lg" required="required" name="keyword"><option value="">Select Product</option>
                                        <%                                                    Statement st1 = SQLconnection.getconnection().createStatement();
                                            ResultSet rt1= st1.executeQuery("SELECT distinct(pname) FROM `spct`.`product`;");
                                            while (rt1.next()) {
                                        %>
                                        <option value="<%=rt1.getString("pname")%>"><%=rt1.getString("pname")%></option>
                                        <%
                                            }
                                        %>
                                    </select><br><br>
                        ...
                        <div class="col-lg-6">
                            <%
                                ...
                                ResultSet rt = st.executeQuery("SELECT * FROM product WHERE pname LIKE '%" + key + "%'");
                            ...
                            %>
                            <div class="portfolio" style="float:left">
                                <h3><%=rt.getString("pname")%></h3>
                                <img src="Getimage?id=<%=id%>" width="300" height="300"><br><br>
                                <p><a href="Review_product.jsp?pid=<%=rt.getString("id")%>&pname=<%=rt.getString("pname")%>" style="font-size: 30px;color: green">Reviews</a><br><span style="width: 300px;font-size: 25px;color: #99ccff"><%=rt.getString("des")%></span></p><br>
                            </div>
