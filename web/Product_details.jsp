            ...
            <section id="about" class="about">
                <div class="container">
                    <div class="row content">
                        <center><h2>Product Details</h2><br><br></center>
                        <table id="customers" style="margin-right: 300px">
                            ...
                            <tr>
                                ...
                                <td><center><img src="Getimage?id=<%=rs.getString("id")%>" width="300" height="250"></center></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><b>Action</b></td>
                                <td><a href="Review_product.jsp?pid=<%=rs.getString("id")%>&pname=<%=rs.getString("pname")%>">Review</a></td>
                            </tr>
                            <%                                        }
                                } catch (Exception ex) {
                                    ex.printStackTrace();
