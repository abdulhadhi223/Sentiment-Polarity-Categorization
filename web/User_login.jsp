            ...
            <section id="about" class="about">
                <div class="container">
                    <div class="row content">
                        <center><h2>User Login</h2><br><br></center>
                        <div class="col-lg-6">
                            <img src="images/ulogin.jpg" class="img-fluid">
                        </div>
                        <div class="col-lg-6">
                            <form action="user_signin.jsp" method="post" role="form">
                                <div class="col-md-6">
                                   <label>Email :</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a href="user_signup.jsp" class="btn-danger btn-lg">Register!</a>
                                </div>
