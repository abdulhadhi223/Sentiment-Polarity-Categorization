            ...
            <div class="container d-flex align-items-center">
                ...
                <nav id="navbar" class="navbar">
                    <ul>
                        ...
                        <li><a class="active" href="User_ratings.jsp">User Ratings</a></li>
            ...
            <section id="about" class="about">
                <div class="container">
                    <div class="row content">
                        <center><h2>User Reviews</h2><br><br></center>
                        <table id="customers" style="margin-right: 300px">
                            ...
                            <%
                                double poscount = 0, negcount = 0, verypos = 0, veryneg = 0, neutralcount = 0;
                                ...
                                try {
                                    ...
                                    while (rs.next()) {
                                        int i = 1;
                                            String temp = "";
                                                float sen = Float.parseFloat(rs.getString("sentiment"));
                                                if (sen > 1) {
                                                    temp = "Very Positive";
                                                }
                                                if (sen > 0 && sen < 1) {
